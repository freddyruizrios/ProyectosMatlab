...
%    2M3-CO
%
function varargout = AreaInscritos(varargin)
%Comienzo de la inicialización del código - NO EDITAR
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AreaInscritos_OpeningFcn, ...
                   'gui_OutputFcn',  @AreaInscritos_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function AreaInscritos_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = AreaInscritos_OutputFcn(hObject, eventdata, handles) 
