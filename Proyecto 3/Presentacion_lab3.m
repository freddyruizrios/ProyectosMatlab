...
%Código fuente del botón avanzar a los cálculos integrales
function btnAvanzar_Callback(hObject, eventdata, handles)
close(Presentacion_lab3) %Cerrar interfaz gráfica de presentación
Integrales_lab3 %Abrir interfaz para realizar los cálculos integrales
