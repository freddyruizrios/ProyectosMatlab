...
%Código fuente del botón avanzar a las gráficas solicitadas
function pushbutton2_Callback(hObject, eventdata, handles)
close(Presentacion) %Cerrar interfaz gráfica de presentación
AreasdeFunciones %Abrir interfaz para realizar las gráficas solicitadas
